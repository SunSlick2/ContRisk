Sub ImportMultipleTSVAndWriteDataHorizontal()
    ...
    With fd
        ...
        If .Show = -1 Then
            ...
            fileIndex = 0 ' Use this to track which set of columns to write to
            
            ' Write headers for all files at the top of the worksheet
            ...
            ws.Cells(4, 5).Value = "Currency"
            ws.Cells(4, 6).Value = "Mid Spot Rate"
            ...
            For Each filePath In .SelectedItems
                ...
                ' Calculate starting column for this file's data
                Dim startCol As Long
                startCol = 2 + (fileIndex * 7) ' Start after headers, with a gap
                
                ' Write Client ID and Cover Ratio
                ws.Cells(1, startCol).Value = clientID
                ws.Cells(2, startCol).Value = coverRatio
                ...
                If dataCollection.Count > 0 Then
                    ...
                    For i = 1 To dataCollection.Count
                        ...
                        Next j
                    Next i
                    ws.Cells(5, startCol).Resize(UBound(totalData, 1), UBound(totalData, 2)).Value = totalData
                End If
                ...
                If fxRates.Count > 0 Then
                    ...
                    For Each key In fxRates.Keys
                        ...
                        i = i + 1
                    Next key
                    ws.Cells(5, startCol + 4).Resize(UBound(fxData, 1), UBound(fxData, 2)).Value = fxData
                End If
