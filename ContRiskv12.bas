...
Sub ImportMultipleTSVAndStackData()
    ...
    With fd
        ...
        If .Show = -1 Then
            ...
            ' Clear the entire worksheet including formatting
            ws.Cells.Clear
            ...
            For Each filePath In .SelectedItems
                ...
                ws.Cells(lastRow, 1).Font.Bold = True ' Bold only Client ID label
                ...
                If dataCollection.Count > 0 Then
                    ...
                    For i = 1 To dataCollection.Count
                        ...
                        ' Apply manipulation logic if ccypair matches M1 and both N1 and O1 have values
                        Dim ccyPair As String
                        ccyPair = dataCollection(i)(0)
                        
                        If Not IsEmpty(ws.Range("M1").Value) Then
                            If ccyPair = ws.Range("M1").Value Then
                                If Not IsEmpty(ws.Range("N1").Value) And Not IsEmpty(ws.Range("O1").Value) Then
                                    ...
                                    divCurrency = ws.Range("N1").Value
                                    mulCurrency = ws.Range("O1").Value
